 ...
 * <ul>
 *   <li>{@link ac.soton.eventb.emf.record.impl.FieldImpl#getType <em>Type</em>}</li>
 *   <li>{@link ac.soton.eventb.emf.record.impl.FieldImpl#getMultiplicity <em>Multiplicity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldImpl extends EventBNamedCommentedElementImpl implements Field {
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RecordPackage.FIELD__TYPE, oldType, type));
	}
	...
	public void setMultiplicity(Multiplicity newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RecordPackage.FIELD__MULTIPLICITY, oldMultiplicity, multiplicity));
	}
