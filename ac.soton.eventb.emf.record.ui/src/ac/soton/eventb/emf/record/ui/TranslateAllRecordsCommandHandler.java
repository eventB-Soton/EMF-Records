 ...
 *******************************************************************************/
package ac.soton.eventb.emf.record.ui;
...
/**
 * Handler to translate all Records in a Machine/Context into Event-B
 * 
 * @author cfs
 *
 */
public class TranslateAllRecordsCommandHandler extends AbstractHandler {
				...
				dialog.run(true, true, new IRunnableWithProgress(){
					public void run(IProgressMonitor monitor) throws InvocationTargetException {
						try {
							...
							TranslateAllRecordsEMFOperation translateAllCmd = new TranslateAllRecordsEMFOperation(editingDomain, (EventBElement) root);
...
//			Activator.logError(Messages.TRANSLATOR_MSG_08, e);
			...
			MessageDialog.openInformation(shell, "Record Translation Information", report);
		}
		return status;
	}
